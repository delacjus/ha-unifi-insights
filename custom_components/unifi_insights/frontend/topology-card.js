...
`,an={gateway:`kind.gateway`,switch:`kind.switch`,access_point:`kind.access_point`,client:`kind.client`,other:`kind.other`},F={online:`state.online`,offline:`state.offline`,unknown:`state.unknown`},on={wired:`medium.wired`,wireless:`medium.wireless`,unknown:`medium.unknown`};function sn(e,t){let n=[...e];return n.length>t?`${n.slice(0,t-1).join(``)}…`:e}var cn=e=>Number.isInteger(e)?String(e):e.toFixed(1);function ln(e){return e>=1e3?`${cn(e/1e3)}G`:`${e}M`}function un(e){return e>=1e3?`${cn(e/1e3)} gigabit`:`${e} megabit`}function dn(e){if(!e)return``;let t=[];return e.parent_port!==void 0&&t.push(`p${e.parent_port}`),e.speed_mbps&&t.push(ln(e.speed_mbps)),e.poe_power_w!==void 0&&t.push(`PoE`),t.join(` · `)}function fn(e,t){return e.type===`group`?e.id===`group:unconnected`?t(`group.unconnected`):e.id===`group:root`?t(`group.root`):e.counts.total===1?t(`group.client_one`):t(`group.clients`,{count:e.counts.total}):e.node.name}function pn(e){return e.type===`group`?e.counts.offline===e.counts.total?`offline`:`online`:e.node.state}function mn(e,t,n){if(t.type===`group`)return`${fn(t,n)}: ${n(`group.summary`,{wireless:t.counts.wireless,offline:t.counts.offline})}`;let r=t.node,i=[n(`node.label`,{kind:n(an[r.kind]),name:r.name,state:n(F[r.state]).toLocaleLowerCase()})],a=e.clientCounts.get(r.id)?.total??0;a>0&&i.push(a===1?n(`node.client_one`):n(`node.clients`,{count:a}));let o=e.edges.get(r.id);return o?.parent_port===void 0?r.connection&&i.push(n(on[r.connection]).toLocaleLowerCase()):i.push(o.speed_mbps?n(`node.uplink_speed`,{port:o.parent_port,speed:un(o.speed_mbps)}):n(`node.uplink`,{port:o.parent_port})),i.join(`, `)}S(`uit-detail-panel`,class extends N{static properties={model:{attribute:!1},selectedId:{attribute:!1},localize:{attribute:!1},narrow:{type:Boolean,reflect:!0},memberQuery:{state:!0}};constructor(){super(),this.narrow=!1,this.memberQuery=``}willUpdate(e){e.has(`selectedId`)&&(this.memberQuery=``)}render(){let{model:e,selectedId:t,localize:n}=this;if(!e||!t||!n)return A;let r=e.visuals.get(t);if(r?.type===`group`)return this.shell(fn(r,n),this.groupBody(r,n));let i=e.nodes.get(t);if(!i)return A;let a=i.kind===`client`?this.clientBody(e,i,n):this.deviceBody(e,i,n);return this.shell(i.name,a)}shell(e,t){let n=this.localize;return D`<section class="panel" role="region" aria-label=${e}>
        ...
        `}renderLink(e,t,n){let r=t.positions.get(e.parentId),i=t.positions.get(e.childId);if(!r||!i)return A;let a=this.orientation===`vertical`?(r.y+i.y)/2:(r.x+i.x)/2,o=this.orientation===`vertical`?`M${r.x},${r.y} C${r.x},${a} ${i.x},${a} ${i.x},${i.y}`:`M${r.x},${r.y} C${a},${r.y} ${a},${i.y} ${i.x},${i.y}`,s=this.showLabels?dn(e.edge):``;return O`<path class=${[`link`,e.edge?.medium??`unknown`,e.viaHidden.length>0?`via-hidden`:``,n.has(e.childId)?`on-path`:``].join(` `)} d=${o}></path>${s?O`<text class="link-label" x=${(r.x+i.x)/2} y=${(r.y+i.y)/2}>${s}</text>`:A}`}renderNode(e,t,n,r,i,a){let o=this.localize,s=t.id,c=pn(t),l=fn(t,o),u=t.type===`group`?`group`:t.node.kind,d=[`node`,t.type,u,c,s===this.selectedId?`selected`:``,i.has(s)?`on-path`:``,this.entering.has(s)?`enter`:``],f=t.type===`group`?zt:Bt(t.node),p=r+16;return O`<g
      class=${d.join(` `)}
      data-id=${s}
      role=${a?`button`:A}
      tabindex=${a?s===this.focusId?0:-1:A}
      aria-label=${a?mn(e,t,o):A}
    ...
    >
      ...
      ${this.showLabels?O`<text class="label" y=${p}>${sn(l,vc)}</text>`:A}
      ${c===`offline`?O`<text class="state-text" y=${this.showLabels?p+14:p}>${o(F.offline)}</text>`:A}
    </g>`}renderGhost(e,t,n){return this.renderNode(e,t.visual,t.point,n,/* @__PURE__ */ new Set,!1)}static styles=[nn,C`
            :host {
                display: block;
                position: relative;
                flex: 1;
        ...
        `}renderRow(e,t,n){let r=t.visual,i=fn(r,n),a=pn(r);return D`<div
        ...
        >
            <span
                ...
                >${t.hasChildren?Vt(t.expanded?Dt:Ot):A}</span
            >
            ${Vt(r.type===`group`?zt:Bt(r.node))}
        ...
        `]});var Sc=600,Cc=`/config/integrations/integration/unifi_insights`,wc={graph:`view.graph`,list:`view.list`},Tc={integration:`action.integration`,edit:`action.edit`},Ec={loading:{key:`state.loading`},no_sources:{key:`state.no_sources`,action:`integration`},unconfigured:{key:`state.unconfigured`,action:`edit`},empty:{key:`state.empty`},incompatible:{key:`state.incompatible`},reloading:{key:`state.reconnecting`}},Dc=e=>e?.nodes.filter(e=>e.kind!==`client`&&e.state===`offline`).length??0,Oc=class extends N{static properties={hass:{attribute:!1},layout:{attribute:!1},config:{state:!0},sources:{state:!0},snapshot:{state:!0},lastGood:{state:!0},error:{state:!0},incompatible:{state:!0},ui:{state:!0},view:{state:!0},selectedId:{state:!0},siteOverride:{state:!0},narrow:{state:!0},reducedMotion:{state:!0},announcement:{state:!0}};subscription=new Tt({onSnapshot:e=>this.applySnapshot(e),onError:e=>{this.error=e},onIncompatible:()=>{this.incompatible=!0}});buildModel=$t();announcer=new pt(e=>{this.announcement=e});sourcesFor;boundKey;cardState={phase:`loading`,stale:!1,notices:[]};model;resizeObserver;motionQuery;localizeLang;localizeFn;constructor(){super(),this.incompatible=!1,this.ui={kinds:new Set(e),clients:`collapsed`,toggledGroups:/* @__PURE__ */ new Set},this.view=`graph`,this.narrow=!1,this.reducedMotion=!1,this.announcement=``}setConfig(e){let t=ne(te(e));this.config=t,this.view=t.view,this.ui={kinds:new Set(t.kinds),clients:t.clients,toggledGroups:/* @__PURE__ */ new Set},this.siteOverride=void 0}getCardSize(){return 8}getGridOptions(){return{columns:12,rows:8,min_columns:6,min_rows:4}}static getConfigElement(){return document.createElement(g)}static async getStubConfig(e){try{let n=re(await e.callWS({type:t}))[0];if(n)return{type:_,...n.binding}}catch{}return{type:_}}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{let t=e[0]?.contentRect.width??0;this.narrow=t>0&&t<Sc}),this.resizeObserver.observe(this),this.motionQuery=window.matchMedia(`(prefers-reduced-motion: reduce)`),this.motionQuery.addEventListener(`change`,this.onMotionChange),this.onMotionChange(),this.sync()}disconnectedCallback(){super.disconnectedCallback(),this.subscription.stop(),this.announcer.dispose(),this.resizeObserver?.disconnect(),this.resizeObserver=void 0,this.motionQuery?.removeEventListener(`change`,this.onMotionChange),this.sourcesFor=void 0}willUpdate(e){(e.has(`hass`)||e.has(`config`)||e.has(`sources`)||e.has(`siteOverride`))&&this.sync();let t=this.config;if(!t)return;this.cardState=vt({sources:this.sources,binding:this.binding,snapshot:this.snapshot,lastGood:this.lastGood,error:this.error,incompatible:this.incompatible,maxClients:t.max_clients}),this.model=this.cardState.render?this.buildModel(this.cardState.render,this.ui):void 0;let n=this.selectedId;n!==void 0&&!(this.model?.visuals.has(n)||this.model?.nodes.has(n))&&(this.selectedId=void 0)}get binding(){return this.config?this.siteOverride??ie(this.config,this.sources):void 0}get localize(){let e=this.hass?.locale?.language??this.hass?.language??`en`;return(e!==this.localizeLang||!this.localizeFn)&&(this.localizeLang=e,this.localizeFn=ce(e)),this.localizeFn}get graphView(){return this.renderRoot.querySelector(`uit-graph-view`)}sync(){let{hass:e,config:t}=this;if(!this.isConnected||!e||!t)return;this.sourcesFor!==e.connection&&(this.sourcesFor=e.connection,this.loadSources(e));let n=this.binding,r=n?`${n.entry_id}\u0000${n.site_id}`:void 0;r!==this.boundKey&&(this.boundKey=r,this.snapshot=void 0,this.lastGood=void 0,this.error=void 0,this.incompatible=!1,this.selectedId=void 0),this.subscription.update(e.connection,n?{...n,max_clients:t.max_clients}:void 0)}async loadSources(e){try{this.sources=await e.callWS({type:t})}catch(e){this.error=bt(e)}}applySnapshot(e){let t=this.snapshot;this.snapshot=e,this.error=void 0,this.incompatible=!1,e.status!==`unavailable`&&e.nodes.length>0&&(this.lastGood=e);let n=this.localize,r=n(`announce.updated`),i=e.issues[0];if(e.status===`unavailable`&&i){let t=gt(i,e,this.config?.max_clients??0);r=n(t.key,t.vars)}else Dc(e)>0&&Dc(e)!==Dc(t)&&(r=n(`announce.offline`,{count:Dc(e)}));this.announcer.announce(r)}onMotionChange=()=>{this.reducedMotion=this.motionQuery?.matches??!1};onActivate=e=>{let t=e.detail.id;this.model?.visuals.get(t)?.type===`group`&&this.toggleGroup(t),this.selectedId=t};onSelect=e=>{let t=e.detail.id,n=this.model;if(n&&!n.visuals.has(t)){let e=tn(n,t);e&&!e.expanded&&this.toggleGroup(e.id)}this.selectedId=t};onToggleGroup=e=>{this.toggleGroup(e.detail.id)};onClose=()=>{this.selectedId=void 0};onKeydown=e=>{e.key===`Escape`&&this.selectedId!==void 0&&(e.stopPropagation(),this.selectedId=void 0)};toggleGroup(e){let t=new Set(this.ui.toggledGroups);t.has(e)?t.delete(e):t.add(e),this.ui={...this.ui,toggledGroups:t}}toggleKind(e){let t=new Set(this.ui.kinds);if(t.has(e)){if(t.size===1)return;t.delete(e)}else t.add(e);this.ui={...this.ui,kinds:t}}runAction(e){xt(e===`integration`?Cc:`${location.pathname}?edit=1`)}render(){let e=this.config;if(!e)return A;let t=this.localize,n=this.cardState,r=this.model,i=e.title??n.render?.site_name??this.snapshot?.site_name??t(`card.name`);return D`<ha-card>
            <div
            ...
            ${this.view===`graph`?D`<div
                  ...
                  >
                      ${this.iconButton(Pt,t(`zoom.in`),()=>this.graphView?.zoomBy(1.25))}
                      ${this.iconButton(Nt,t(`zoom.out`),()=>this.graphView?.zoomBy(.8))}
                      ${this.iconButton(jt,t(`zoom.fit`),()=>this.graphView?.fit())}
                  </div>`:A}
        ...
        </ul>`}renderMessage(e,t){let n=Ec[e.phase],r={site:this.snapshot?.site_name??``},i=[];return n&&i.push({...n,vars:r}),i.push(...e.notices),D`<div class="message ${e.phase}">
        ...
        `]},kc=`current`,Ac=``,jc={graph:`view.graph`,list:`view.list`},Mc={collapsed:`clients.collapsed`,expanded:`clients.expanded`,hidden:`clients.hidden`},Nc={auto:`density.auto`,comfortable:`density.comfortable`,compact:`density.compact`},Pc={vertical:`orientation.vertical`,horizontal:`orientation.horizontal`},Fc={site:`editor.site`,title:`editor.title`,view:`editor.view`,clients:`editor.clients`,kinds:`editor.kinds`,density:`editor.density`,orientation:`editor.orientation`,show_site_selector:`editor.show_site_selector`,show_labels:`editor.show_labels`,max_clients:`editor.max_clients`};function Ic(e,t,n){return e.map(e=>({value:e,label:n(t[e])}))}var Lc=(e,t)=>typeof e==`string`&&t.includes(e);function Rc(e,t){let{entry_id:n,site_id:r}=e;if(n===void 0||r===void 0)return Ac;let i=t.findIndex(e=>ae(e.binding,{entry_id:n,site_id:r}));return i>=0?String(i):kc}function zc(t,n,r){let i=n.map((e,t)=>({value:String(t),label:e.label}));return Rc(t,n)===`current`&&i.push({value:kc,label:r(`editor.site_unavailable`,{site:t.site_id??``})}),[{name:`site`,selector:{select:{mode:`dropdown`,options:i}}},{name:`title`,selector:{text:{}}},{name:``,type:`grid`,schema:[{name:`view`,selector:{select:{mode:`dropdown`,options:Ic(v,jc,r)}}},{name:`clients`,selector:{select:{mode:`dropdown`,options:Ic(y,Mc,r)}}},{name:`density`,selector:{select:{mode:`dropdown`,options:Ic([`auto`,...b],Nc,r)}}},{name:`orientation`,selector:{select:{mode:`dropdown`,options:Ic(ee,Pc,r)}}}]},{name:`kinds`,selector:{select:{multiple:!0,mode:`list`,options:Ic(e,an,r)}}},{name:`show_site_selector`,selector:{boolean:{}}},{name:`show_labels`,selector:{boolean:{}}},{name:`max_clients`,selector:{number:{min:1,max:500,mode:`box`}}}]}function Bc(t,n){return{site:Rc(t,n),title:t.title??``,view:t.view??`graph`,clients:t.clients??`collapsed`,density:t.density??`auto`,orientation:t.orientation??`vertical`,kinds:t.kinds?[...t.kinds]:[...e],show_site_selector:t.show_site_selector??!1,show_labels:t.show_labels??!0,max_clients:t.max_clients??500}}function Vc(t,n,r){let i={...n},a=t.site??Ac;if(a===Ac)delete i.entry_id,delete i.site_id;else if(a!==`current`){let e=r[Number(a)];e&&(i.entry_id=e.binding.entry_id,i.site_id=e.binding.site_id)}t.title?i.title=t.title:delete i.title,Lc(t.view,v)&&(i.view=t.view),Lc(t.clients,y)&&(i.clients=t.clients),Lc(t.orientation,ee)&&(i.orientation=t.orientation),Lc(t.density,b)?i.density=t.density:t.density===`auto`&&delete i.density;let o=(t.kinds??[]).filter(t=>Lc(t,e));o.length===e.length?delete i.kinds:o.length>0&&(i.kinds=e.filter(e=>o.includes(e))),typeof t.show_site_selector==`boolean`&&(i.show_site_selector=t.show_site_selector),typeof t.show_labels==`boolean`&&(i.show_labels=t.show_labels);let s=t.max_clients;return typeof s==`number`&&Number.isInteger(s)&&s>=1&&s<=500&&(i.max_clients=s),i}async function Hc(e=customElements,t=window.loadCardHelpers){e.get(`ha-form`)||await((await t?.())?.createCardElement({type:`entities`,entities:[]})?.constructor)?.getConfigElement?.()}var Uc=class extends N{static properties={hass:{attribute:!1},config:{state:!0},sources:{state:!0},formReady:{state:!0}};sourcesRequested=!1;constructor(){super(),this.formReady=!1}setConfig(e){this.config={...e}}connectedCallback(){super.connectedCallback(),Hc().catch(()=>void 0).then(()=>{this.formReady=!0})}willUpdate(){this.hass&&!this.sourcesRequested&&(this.sourcesRequested=!0,this.hass.callWS({type:t}).then(e=>{this.sources=e},()=>{this.sources=[]}))}render(){let{hass:e,config:t}=this;if(!e||!t)return A;let n=ce(e.locale?.language??e.language);if(!this.formReady)return D`<p>${n(`state.loading`)}</p>`;let r=re(this.sources??[]);return D`<ha-form
            .hass=${e}
            .data=${Bc(t,r)}
            .schema=${zc(t,r,n)}
            .computeLabel=${e=>{let t=Fc[e.name];return t?n(t):``}}
            @value-changed=${this.onValueChanged}
        ></ha-form>`}onValueChanged=e=>{e.stopPropagation();let t=this.config;if(!t)return;let n=e.detail.value,r=Vc(n,t,re(this.sources??[]));this.config=r,P(this,`config-changed`,{config:r})}};S(h,Oc),S(g,Uc);var Wc=ce(`en`);window.customCards??=[],window.customCards.some(e=>e.type===`unifi-insights-topology-card`)||window.customCards.push({type:h,name:Wc(`card.name`),description:Wc(`card.description`),preview:!0,documentationURL:`https://github.com/ruaan-deysel/ha-unifi-insights#network-topology-card`});